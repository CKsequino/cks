...
(function () {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function (e) {
            ...
            // Sending state
            btn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width:18px;height:18px;fill:currentColor;flex-shrink:0;animation:spin 0.8s linear infinite"><path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z"/></svg>&nbsp;Sending…';
            btn.disabled  = true;
            ...
            // Send via Formspree — replace YOUR_FORM_ID with actual ID after registering
            fetch('https://formspree.io/f/xeebwyvq', {
                method:  'POST',
            ...
            .catch(function (err) {
                ...
                btn.innerHTML = originalHTML;
                btn.disabled  = false;
                showToast('Failed to send. Please email me at clarkkentsequino269@gmail.com', '❌');
            });
        });
    }
